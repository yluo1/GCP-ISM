...
$$\textrm{GCP}(k, N) = \left\lbrace \begin{array}{c c} 1 + 2 \lfloor k \rfloor, & N = 1\newline \sum_{m = -\lfloor k \rfloor}^{\lfloor k \rfloor } \textrm{GCP}(\sqrt{k^2 - m^2}, N-1), & N > 1\end{array}\right. .$$
